...
<?php 
$sql = "select * from tbl_Admin where adminId=".$_SESSION["cId"];
...
if(isset($_REQUEST["update"])){
    $sql = "UPDATE tbl_Admin SET fName='".$_POST["fName"]."' , lName='".$_POST["lName"]."' , contact='".$_POST["contactNumber"]."' , email='".$_POST["email"]."'  WHERE adminId=".$_SESSION["cId"];
      ...
      <form action="#" method="post">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fName" value="<?php echo $fName;?>" id="fName" placeholder="Enter First Name" class="form-control" readonly="">
                    <?php echo $fnamemsg?>
                    </div>
                    </div>
                <div class="col-lg-6">
